...
type CalculationFunction = (this: TokenNode, n: TokenNode, calculationData?: any) => any;
type NodeConstructorImpl = new () => TokenNode;
...
function generateNode(
    type: string, name: string, chaincodeName: string, methodName: string, additionalProperties: Record<string, any>|undefined, intfs: IInterfaceOptions[],
    options: Map<string, INodeOptionParameters>, calcFunction?: CalculationFunction
) {
    return class extends TokenNode {

        type = type;
        name = name;

        constructor() {
            super(chaincodeName, methodName);
...
export class ComputeNodeBuilder {
     ...
     */
    public constructor(type: string, chaincodeName: string, methodName: string, additionalProperties?: Record<string, any>) {
        this.type = type;
        this.name = type;
    ...
    public build(): NodeConstructorImpl {
        return generateNode(this.type, this.name, this.chaincodeName, this.methodName, this.additionalProperties, this.intfs, this.options, this.calcFunction);
    }
     ...
     */
    public setName(name: string): ComputeNodeBuilder {
        this.name = name;
        return this;
    }
    ...
    public addInputInterface(name: string, option?: string, defaultValue: any = null,
                             additionalProperties?: Record<string, any>): ComputeNodeBuilder {
     ...
     * @returns Current node builder instance for chaining
     */
    public addOutputInterface(name: string, additionalProperties?: Record<string, any>): ComputeNodeBuilder {
    ...
    public addOption(name: string, optionComponent: string, defaultValue: any = null,
                     sidebarComponent?: string, additionalProperties?: Record<string, any>): ComputeNodeBuilder {
        this.checkDefaultValue(defaultValue);
     ...
     * @returns Current node builder instance for chaining
     */
    public onCalculate(cb: CalculationFunction): ComputeNodeBuilder {
