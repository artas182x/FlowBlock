...
export CORE_PEER2_ORG1_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org1.example.com/peers/peer2.org1.example.com/tls/ca.crt
export CORE_PEER2_ORG2_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer2.org2.example.com/tls/ca.crt
export CORE_PEER2_ORG3_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org3.example.com/peers/peer2.org3.example.com/tls/ca.crt
export CORE_PEER2_ORG4_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer2.org4.example.com/tls/ca.crt
...
export CORE_PEER2_ORG1_ADDRESS=localhost:7251
export CORE_PEER2_ORG2_ADDRESS=localhost:9251
export CORE_PEER2_ORG3_ADDRESS=localhost:11251
export CORE_PEER2_ORG4_ADDRESS=localhost:12251
